      ...
      features: [
        ...
        },
        {
          ...
          subs: [
            ...
            { name: '지도 기반 목적지 지정 (Waypoint 위젯)', s: P, id: 'SR-ADM-004' },
      ...
      features: [
        {
          ...
          subs: [
            ...
            { name: '잡담 응답', s: P, id: 'SR-VOICE-004' },
            { name: '모드 전환 (latched 토픽)', s: P, id: 'SR-OPS-001' },
        ...
        },
        {
          ...
          subs: [
            { name: '얼굴 캡처 (등록 얼굴 등장 시)', s: P, id: 'SR-IN-001' },
            { name: '얼굴 식별 (다중 임베딩 매칭)', s: P, id: 'SR-IN-002' },
            { name: '환영 인사 출력 (TTS)', s: P, id: 'SR-IN-003' },
            { name: '환영 모션 (OpenArm trajectory)', s: P, id: 'SR-IN-004' },
            { name: '등원 시각 기록 (DB attendance INSERT)', s: X, id: 'SR-IN-006' },
          ],
        },
        {
          name: '하원 모드',
          ...
          subs: [
            { name: '얼굴 캡처', s: P, id: 'SR-OUT-001' },
            { name: '얼굴 식별', s: P, id: 'SR-OUT-002' },
            { name: '작별 인사 출력 (TTS)', s: P, id: 'SR-OUT-003' },
            { name: '작별 모션', s: P, id: 'SR-OUT-004' },
            { name: '하원 시각 기록 + 보고서 enqueue', s: X, id: 'SR-OUT-006' },
          ],
        },
        {
          name: '율동 모드',
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          subs: [
            { name: 'UI · vision 프리뷰 · URDF 뷰어', s: P, id: 'SR-PLAY-010' },
            { name: '문제 추출 + 5초 카운트다운', s: P, id: 'SR-PLAY-010' },
            { name: '손 터치 검출 (mediapipe Hands)', s: P, id: 'SR-PLAY-011' },
            { name: '정답 trajectory 재생 (rule_based)', s: X, id: 'SR-PLAY-010' },
  ...
  const portal = [
    {
      ...
      features: [
        ...
        { name: '사진첩', image: 'demo/parent/photos.png', subs: [
          { name: '자녀 포함 사진 리스트 · 다운로드', s: P, id: 'SR-PHOTO-003' },
        ]},
    ...
    },
    {
      ...
      features: [
        ...
        { name: '아이 · 학부모 등록', image: 'demo/teacher/children-new.png', subs: [
          ...
          { name: '얼굴 캡처 — 15장 다각도', s: P, id: 'SR-REG-005' },
          { name: '얼굴 캡처 — anti-spoofing (liveness)', s: P, id: 'SR-REG-010' },
          { name: '얼굴 임베딩 저장 (DB BLOB)', s: X, id: 'SR-REG-006' },
        ]},
