...
이어야 하지만 (사실상 timeout 없는 task), 현재 stub: SUCCESS 로
끝내서 IDLE 복귀 사이클 검증.

## 교체 시점

사용처: BT_assist_main 의 TaskSelector ASSIST/follow 자식.
...
class StubFollow(StubRunningThenSuccess):
    ...
    # STUB — bt/trees/sub_trees/BT_follow_sub.py 의 build_follow 로 교체.
    """
