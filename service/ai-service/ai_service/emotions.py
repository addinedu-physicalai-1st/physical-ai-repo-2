...
프론트엔드 `service/web-service/robot-web/src/config/emotions.ts` 와 동일한 파일을 읽는다.
"""
import json
from pathlib import Path
from typing import TypedDict

# service/ai-service/ai_service/emotions.py → repo root → shared/emotions.json
_PATH = Path(__file__).resolve().parents[3] / "shared" / "emotions.json"
