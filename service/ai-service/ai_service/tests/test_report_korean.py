...
from ai_service.llm import _schedule_prompt_block
...
def test_timeline_anchor_allowed_only_end_when_check_in_db() -> None:
    from ai_service.korean_postprocess import timeline_no_data_anchor_allowed_times
...
def test_slot_label_at_time_sorted_prefers_later_slot_at_hour_boundary() -> None:
    from ai_service.korean_postprocess import _slot_label_at_time_sorted
