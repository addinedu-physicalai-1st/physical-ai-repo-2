...
def _install_ai_hub_mock(monkeypatch, *, response_json: dict):
    ...
    from control_service.routers import reports as reports_module
...
async def test_pending_excludes_children_with_existing_report(
    ...
    from control_db.models import Attendance, Child, Report
...
async def test_generate_report_inserts_new_row(
    ...
    from control_db.models import Child, Menu, Photo, PhotoSubject, Report
    from sqlalchemy import select
...
async def test_generate_report_attendance_debug_matches_db(
    ...
    from control_db.models import Attendance, Child, Menu
...
async def test_generate_report_excludes_other_childs_photos(
    ...
    """
    from control_db.models import Child, Photo, PhotoSubject
    import json
...
async def test_generate_report_backfills_unmapped_photo_classification(
    ...
    from control_db.models import Child, ChildFaceEmbedding, Photo, PhotoSubject
    from sqlalchemy import select
